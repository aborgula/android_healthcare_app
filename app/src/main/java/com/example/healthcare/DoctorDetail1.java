...
public class DoctorDetail1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_detail_dentist1);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DoctorDetail1.this, FindDoctorActivity.class));
            }
        });
        ...
        switch(title) {
            case "dermatologist": {
                fullname.setText("Mia Taerico");
                address.setText("Whiskonsin");
                fees.setText("110");
                phonenumber.setText("574444672");
                break;
            }
            case "dietician": {
                fullname.setText("Miles McMiller");
                address.setText("Iowa");
                fees.setText("90");
                phonenumber.setText("4451777443");
                break;
            }
            case "surgeon": {
                fullname.setText("Marley Gomez");
                address.setText("Los Angeles");
                fees.setText("270");
                phonenumber.setText("5099907787");
                break;
            }
            case "cardiologist": {
                fullname.setText("Eva Tilde");
                address.setText("Seattle");
                fees.setText("190");
                phonenumber.setText("666220999");
                break;
            }
            case "dentist": {
                fullname.setText("Lincoln Culney");
                address.setText("Colorado");
                fees.setText("120");
                phonenumber.setText("775532444");
                break;
            }
        }
        ...
        bookappointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(db.checkAppointmentExists(username, titletv.getText().toString() + " => " + fullname.getText().toString(), address.getText().toString(), phonenumber.getText().toString(), datepicker.getText().toString(), timepicker.getText().toString()) == 1) {
                    ...
                    startActivity(new Intent(DoctorDetail1.this, HomeActivity.class));
                }
            }
        });
    }
        ...
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Math.abs(deltaX) > Math.abs(deltaY)){
                    if(deltaX > 0){
                        // Swipe w prawo
                        Intent intent = new Intent(DoctorDetail1.this, DoctorDetailActivity.class);
                        intent.putExtra("title", titletv.getText().toString());
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                    } else {
                        // Swipe w lewo
                        Intent intent = new Intent(DoctorDetail1.this, DoctorDetail2.class);
                        intent.putExtra("title", titletv.getText().toString());
                        startActivity(intent);                            // overridePendingTransition(R.anim.slide_out_left, R.anim.slide_in_right);
